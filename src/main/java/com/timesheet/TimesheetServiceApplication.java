	...
	CommandLineRunner clr(EmployeeService employeeService, SheetdayService sheetdayService, RoleRepository appRoleRepository,USAIDProjectRepository projectRepository,
		...
		return  args->{
			...
			*/
			...
			employeeService.addNewEmployee("USER1", "FARADJA", "Ong", "user1@maisonfaradja.org", Positions.OTHER);
			employeeService.addNewEmployee("USER2", "FARADJA", "Ong", "user2@maisonfaradja.org", Positions.OTHER);
			employeeService.addNewEmployee("USER3", "FARADJA", "Ong", "user3@maisonfaradja.org", Positions.OTHER);
			employeeService.addNewEmployee("USER4", "FARADJA", "Ong", "user4@maisonfaradja.org", Positions.OTHER);
			employeeService.addNewEmployee("USER5", "FARADJA", "Ong", "user5@maisonfaradja.org", Positions.OTHER);
//			Add roles
			...
			employeeService.setSupervisorToEmployee("SEYA", "USER1");
			employeeService.setSupervisorToEmployee("SEYA", "USER2");
			employeeService.setSupervisorToEmployee("SEYA", "USER3");
			employeeService.setSupervisorToEmployee("SEYA", "USER4");
			employeeService.setSupervisorToEmployee("SEYA", "USER5");
...
//			Add roles to users
			...
			List<Sheetday>sheetdays13=sheetdayService.getNewTimesheetLine(tp.getPrecedentPeriod(tp.getCurrentPeriod()), employeeService.getEmployeeID("USER1"), "", "USAID ULINZI");
			List<Sheetday>sheetdays14=sheetdayService.getNewTimesheetLine(tp.getPrecedentPeriod(tp.getCurrentPeriod()), employeeService.getEmployeeID("USER2"), "", "USAID ULINZI");
			List<Sheetday>sheetdays15=sheetdayService.getNewTimesheetLine(tp.getPrecedentPeriod(tp.getCurrentPeriod()), employeeService.getEmployeeID("USER3"), "", "USAID ULINZI");
			List<Sheetday>sheetdays16=sheetdayService.getNewTimesheetLine(tp.getPrecedentPeriod(tp.getCurrentPeriod()), employeeService.getEmployeeID("USER4"), "", "USAID ULINZI");
			List<Sheetday>sheetdays17=sheetdayService.getNewTimesheetLine(tp.getPrecedentPeriod(tp.getCurrentPeriod()), employeeService.getEmployeeID("USER5"), "", "USAID ULINZI");
			...
			TimesheetSaver userSavedS13=new TimesheetSaver(null, employeeService.getEmployeeID("USER1"), tp.getPrecedentPeriod(tp.getCurrentPeriod()), false, false, false, false, false, false);
			TimesheetSaver userSavedS14=new TimesheetSaver(null, employeeService.getEmployeeID("USER2"), tp.getPrecedentPeriod(tp.getCurrentPeriod()), false, false, false, false, false, false);
			TimesheetSaver userSavedS15=new TimesheetSaver(null, employeeService.getEmployeeID("USER3"), tp.getPrecedentPeriod(tp.getCurrentPeriod()), false, false, false, false, false, false);
			TimesheetSaver userSavedS16=new TimesheetSaver(null, employeeService.getEmployeeID("USER4"), tp.getPrecedentPeriod(tp.getCurrentPeriod()), false, false, false, false, false, false);
			TimesheetSaver userSavedS17=new TimesheetSaver(null, employeeService.getEmployeeID("USER5"), tp.getPrecedentPeriod(tp.getCurrentPeriod()), false, false, false, false, false, false);
